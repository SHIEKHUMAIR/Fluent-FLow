      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="group bg-white/90 hover:bg-white shadow-lg hover:shadow-2xl border border-white/50 rounded-3xl p-8 transition-all duration-300 transform hover:scale-105 hover:cursor-pointer">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-4">UNIT 1: FOUNDATION</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
              Learn the essential Chinese sounds and tones through native audio, guided pinyin charts, and  pronunciation practice.
            </p>
          ...
          <div className="group bg-white/90 hover:bg-white shadow-lg hover:shadow-2xl border border-white/50 rounded-3xl p-8 transition-all duration-300 transform hover:scale-105 hover:cursor-pointer">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-4">UNIT 2: Daily Life & Words</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
          ...
          <div className="group bg-white/90 hover:bg-white shadow-lg hover:shadow-2xl border border-white/50 rounded-3xl p-8 transition-all duration-300 transform hover:scale-105 hover:cursor-pointer">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-4">UNIT 3: Elementary Mandarin</h3>

            <p className="text-slate-600 mb-6 leading-relaxed">
              Explore describing people, numbers, and technology, and practice vocabulary to build a solid foundation.
            </p>
          ...
          <div className="group bg-white/90 hover:bg-white shadow-lg hover:shadow-2xl border border-white/50 rounded-3xl p-8 transition-all duration-300 transform hover:scale-105 hover:cursor-pointer">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-4">UNIT 4: Work & Travel</h3>

            <p className="text-slate-600 mb-6 leading-relaxed">
              Master vocabulary for work, business, travel, and emergency situations.
            </p>
