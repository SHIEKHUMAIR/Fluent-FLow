  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const unit = unitsResult.data.find(u => u.unit_number === 2);
        if (!unit) {
          setError("Unit 2 not found");
          return;
        }

        // Get lessons for unit 2
            ...
            return (
              ...
              >
                <div className="p-8">
                  ...
                  {/* Button */}
                  <Link href={lesson.path || `/modules/unit02/lesson${lesson.lesson_number}`}>
                    <button
