    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const unit4 = unitsResult.data.find(u => u.unit_number === 4);
                if (!unit4) {
                    setError("Unit 4 not found");
                    return;
                }

                // Get lessons for unit 4
                const lessonsResult = await apiGet(API_ENDPOINTS.LESSONS.BY_UNIT(unit4.id));
                        ...
                        return (
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    {/* Button */}
                                    <Link href={lesson.path || `/modules/unit04/lesson${lesson.lesson_number}`}>
                                        <button
