    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const unit = unitsResult.data.find(u => u.unit_number === 6);
                if (!unit) {
                    setError("Unit 6 not found");
                    return;
                }

                // Get lessons for unit 6
                        ...
                        return (
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    {/* Button */}
                                    <Link href={lesson.path || `/modules/unit06/lesson${lesson.lesson_number}`}>
                                        <button
