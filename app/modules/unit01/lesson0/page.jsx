...
import Lesson0 from '../../../components/Unit01/lesson0'
...
const page = () => {
  ...
  <Link href="/modules/unit01" className="absolute left-8">
    <button
  ...
  <h1 className="text-5xl font-bold text-blue-900 text-center pt-5">
    Lesson 0 <br />
    <span className="text-slate-600 font-medium text-3xl">Introduction</span>
  </h1>
</div>
    <Lesson0/>
    </>
