    ...
    return (
        <>
            <div className="relative flex items-center justify-center mt-8">
                <Link href="/modules/unit06" className="absolute left-8">
                    <button
                ...
                <h1 className="text-5xl font-bold text-blue-900 text-center pt-5">
                    Lesson 43 <br />
                    <span className="text-slate-600 font-medium text-3xl">Asking for Directions</span>
                </h1>
            </div>

            <Lesson unitNumber={6} lessonNumber={43} />
        </>
    )
}
