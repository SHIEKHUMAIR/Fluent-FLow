// Define both URLs for easy switching
const API_URL_LOCAL = "http://localhost:4000";
const API_URL_PROD = "https://fluent-flow-backend.onrender.com";
const API_URL_PYTHON_LOCAL = "http://localhost:5000";
const API_URL_PYTHON_PROD = "https://shiekhumair-fluent-flow-chatbot.hf.space";

// API URLs
export const API_BASE_URL = API_URL_PROD;
export const API_PYTHON_URL = API_URL_PYTHON_PROD;
...
export const API_ENDPOINTS = {
  ...
  PROGRESS: {
    ...
    MARK_SEEN: `${API_BASE_URL}/api/progress/mark-seen`,
  ...
  CHATBOT: {
    GENERATE: `${API_BASE_URL}/api/chatbot/generate-roadmap`,
  },
};