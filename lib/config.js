...
// Use environment variable first, then fallback to PROD (Success case) or LOCAL as needed
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || API_URL_PROD;
